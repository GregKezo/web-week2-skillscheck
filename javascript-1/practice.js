...
const me = {
	...
	,age: 32
	,greeter: function() {
		return `Hello! My name is ${firstName} and I live in ${Utah}`
	}
}
...
const doubled = myNumbers.map(ele => ele * 2)
...
const forTheLoveOfGeorge = notGeorge.map(ele => 'George')
...
const enemies = people.filter(ele => ele.friend !== true)
